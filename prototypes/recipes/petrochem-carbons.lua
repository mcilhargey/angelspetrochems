...
--CARBON
    ...
    results=
    {
		{type="item", name="solid-pet-coke", amount=2},
    ...
    order = "f[gas-synthesis-separation]",
	},
	{
    type = "recipe",
    ...
    ingredients ={
        ...
        {type="item", name="catalyst-aluminium", amount=1},				--Zn and Al
	},
    results=
    {
    ...
    order = "g[gas-synthesis-methanol]",
	},
	{
    type = "recipe",
    ...
    order = "h[steam-cracking-residual]",
	},
	--OIL FEED
	{
    type = "recipe",
    ...
    order = "g[liquid-mineral-oil-catalyst]",
	},
	{
    type = "recipe",
